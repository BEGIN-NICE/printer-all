...
*/
    ...
    /**
     ...
     打印二维码
     @param qrData 二维码的内容
     @throws IOException */ protected void qrCode(String qrData) throws IOException {
         int moduleSize = 8;
...
//    socketOut.write(bytes);
    ...
    /**
     ...
     打印换行(只换一行)
     @throws IOException */ protected void printLine() throws IOException { writer.write("\n"); writer.flush(); }
    /**

     打印空白(一个Tab的位置，约4个汉字)
     @param length 需要打印空白的长度,
     @throws IOException */ protected void printTabSpace(int length) throws IOException {
     ...
     *
     ...
     打印空白（一个汉字的位置）
     @param length 需要打印空白的长度,
     @throws IOException */ protected void printWordSpace(int length) throws IOException { for (int i = 0; i < length; i++) { writer.write(" "); } writer.flush(); }
    ...
    /**
     ...
     绝对打印位置
     @throws IOException */ protected void printLocation(int light, int weight) throws IOException {
         writer.write(0x1B);
         writer.write(0x24);
         writer.write(light);
         writer.write(weight);
    ...
    /**
     ...
     @param
     @throws IOException */
    protected void printTextBig(Integer weight,Integer high) throws IOException {
        socketOut.write(0x1B);
        socketOut.write(0x52);
        socketOut.write(15);

        //
        socketOut.write(0x1B);
        socketOut.write(0x21);
        socketOut.write(0x08);


        socketOut.write(0x1B);
        socketOut.write(0x4D);
        socketOut.write(0x0);


        socketOut.write(0x1D);
        socketOut.write(0x21);
        socketOut.write(weight);
        socketOut.write(0x1D);
        socketOut.write(0x21);
        socketOut.write(high);
    }
    /**
